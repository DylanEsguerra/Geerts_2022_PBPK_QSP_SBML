"""
This version avoids the and in the piecewise function.
...
def create_geerts_model(params, params_with_units):
    ...
    # Create a more scalable function for IV dosing using nested piecewise to avoid three-condition and
    iv_math_formula = """
    piecewise(
        piecewise(
        ...
        (time < MaxDosingTime) && (floor(time / IV_DoseInterval) < IV_NumDoses),
        0
    )
    """
    ...
    # Create a more scalable function for SC dosing using nested piecewise to avoid three-condition and
    sc_math_formula = """
    piecewise(
        piecewise(
        ...
        (time < MaxDosingTime) && (floor(time / SC_DoseInterval) < SC_NumDoses),
        0
    )
    """
